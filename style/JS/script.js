...
botao.addEventListener('click', function(){
    ...
    if(imagem.src.includes('style/imagens/SetaParaBaixo.svg')){
        imagem.src = 'style/imagens/SetaParaCima.svg'
        imagem.alt = 'Seta para cima'
    } else {
        imagem.src = 'style/imagens/SetaParaBaixo.svg'
...
function tracaImagem1(){
    ...
    imagemGrande.src = 'style/imagens/menu01.jpg'
}

function tracaImagem2(){
    var imagemGrande = document.getElementById('imagemCriancaGrande')

    imagemGrande.src = 'style/imagens/menu02.jpg'
}

function tracaImagem3(){
    var imagemGrande = document.getElementById('imagemCriancaGrande')

    imagemGrande.src = 'style/imagens/menu03.jpg'
}

function tracaImagem4(){
    var imagemGrande = document.getElementById('imagemCriancaGrande')

    imagemGrande.src = 'style/imagens/menu04.jpg'
}